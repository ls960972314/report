...
public class Member implements java.io.Serializable {
	...
	public boolean equals(Object other) {
		...
		return ((this.getId() == castOther.getId())
				...
				&& ((this.getUpdateTime() == castOther.getUpdateTime()) || (this.getUpdateTime() != null
						&& castOther.getUpdateTime() != null && this.getUpdateTime().equals(castOther.getUpdateTime())))
				&& ((this.getMemberType() == castOther.getMemberType()) || (this.getMemberType() != null
						&& castOther.getMemberType() != null && this.getMemberType().equals(castOther.getMemberType())))
				...
				&& ((this.getExtend() == castOther.getExtend()) || (this.getExtend() != null
						&& castOther.getExtend() != null && this.getExtend().equals(castOther.getExtend())))
				&& ((this.getUserNick() == castOther.getUserNick()) || (this.getUserNick() != null
						&& castOther.getUserNick() != null && this.getUserNick().equals(castOther.getUserNick())))
				&& ((this.getUserCity() == castOther.getUserCity()) || (this.getUserCity() != null
						&& castOther.getUserCity() != null && this.getUserCity().equals(castOther.getUserCity())))
				&& ((this.getBankId() == castOther.getBankId()) || (this.getBankId() != null
						&& castOther.getBankId() != null && this.getBankId().equals(castOther.getBankId())))
				...
				&& ((this.getAuthLastTime() == castOther.getAuthLastTime())
						|| (this.getAuthLastTime() != null && castOther.getAuthLastTime() != null
								&& this.getAuthLastTime().equals(castOther.getAuthLastTime())))
				&& ((this.getQrcodeUrl() == castOther.getQrcodeUrl()) || (this.getQrcodeUrl() != null
						&& castOther.getQrcodeUrl() != null && this.getQrcodeUrl().equals(castOther.getQrcodeUrl())))
				...
				&& ((this.getSchId() == castOther.getSchId()) || (this.getSchId() != null
						&& castOther.getSchId() != null && this.getSchId().equals(castOther.getSchId())))
				&& ((this.getChangeCardLastTime() == castOther.getChangeCardLastTime())
						|| (this.getChangeCardLastTime() != null && castOther.getChangeCardLastTime() != null
								&& this.getChangeCardLastTime().equals(castOther.getChangeCardLastTime())))
				&& ((this.getQrEmailImageUrl() == castOther.getQrEmailImageUrl())
						|| (this.getQrEmailImageUrl() != null && castOther.getQrEmailImageUrl() != null
								&& this.getQrEmailImageUrl().equals(castOther.getQrEmailImageUrl())))
				&& ((this.getCreaterId() == castOther.getCreaterId()) || (this.getCreaterId() != null
						&& castOther.getCreaterId() != null && this.getCreaterId().equals(castOther.getCreaterId())))
				&& ((this.getModifierId() == castOther.getModifierId())
						|| (this.getModifierId() != null && castOther.getModifierId() != null
								&& this.getModifierId().equals(castOther.getModifierId())));
	}
	...
	public int hashCode() {
		...
		result = 37 * result + (getExtend() == null ? 0 : this.getExtend().hashCode());
		result = 37 * result + (getUserNick() == null ? 0 : this.getUserNick().hashCode());
		result = 37 * result + (getUserCity() == null ? 0 : this.getUserCity().hashCode());
		...
		result = 37 * result + (getAuthLastTime() == null ? 0 : this.getAuthLastTime().hashCode());
		result = 37 * result + (getQrcodeUrl() == null ? 0 : this.getQrcodeUrl().hashCode());
		result = 37 * result + (getPartner() == null ? 0 : this.getPartner().hashCode());
		result = 37 * result + (getSchId() == null ? 0 : this.getSchId().hashCode());
		result = 37 * result + (getChangeCardLastTime() == null ? 0 : this.getChangeCardLastTime().hashCode());
		result = 37 * result + (getQrEmailImageUrl() == null ? 0 : this.getQrEmailImageUrl().hashCode());
		result = 37 * result + (getCreaterId() == null ? 0 : this.getCreaterId().hashCode());
		result = 37 * result + (getModifierId() == null ? 0 : this.getModifierId().hashCode());
		return result;
	}

...
public class Excel2007Reader extends DefaultHandler {  
    ...
    private boolean isBlankElement;
    ...
    public void startElement(String uri, String localName, String name,  
        ...
        if ("c".equals(name)) {  
            ...
            //日期格式   1文本 2时间 3数字
            String cellFormatType = attributes.getValue("s");  
            if ("2".equals(cellFormatType)){  
                dateFlag = true;  
            } else {  
                dateFlag = false;  
            }  
            if("3".equals(cellFormatType)){  
                numberFlag = true;  
            } else {  
                numberFlag = false;  
            }  
    ...
    public void endElement(String uri, String localName, String name)  
        ...
        if(isTElement){
            ...
            curCol++;  
            isTElement = false;  
        } else if (isBlankElement && "c".equals(name)) {
            rowlist.add(curCol, "");  
            curCol++;
            isBlankElement = false;

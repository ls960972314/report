...
<body style="overflow-y: hidden">
        ...
        <tr>
            ...
            <td valign="top">
               <div class="extendDiv-toggle">
                ...
                <!-- 数据列表 -->
                <table id="groupList"
                    url="${pageContext.request.contextPath}/group/findGroupList.htm" toolbar="#toolbar"
    ...
    <div id="toolbar">
        <div style="margin-bottom: 5px">
                ...
                <a href="#" class="easyui-linkbutton" iconCls="icon-add" plain="true"
                    onclick="addObject('新建组','${pageContext.request.contextPath}/group/addOrUpdateGroup.htm','groupDialog', 'groupForm')">新建</a>
                <a href="#" class="easyui-linkbutton" iconCls="icon-edit" plain="true"
                    onclick="editGroup()">编辑</a>
                <a href="#" class="easyui-linkbutton" iconCls="icon-remove" plain="true"
                    onclick="deleteObject('groupList', '${pageContext.request.contextPath}/group/deleteGroup.htm', false)">删除</a>
                |<a href="#" class="easyui-linkbutton" plain="true"
                    onclick="showDetailForGroup()">详情</a>
               <a href="#" class="easyui-linkbutton" plain="true"
                   onclick="showRoleList()">查看角色</a>
    ...
    <!-- 对话框 -->
    <div id="groupUpdateDialog" class="easyui-dialog"
    data-options="width : 480, closable : true, modal : true, closed : true, shadow : false"
        buttons="#group-buttons-update">
    ...
    <!-- 显示角色列表对话框 -->
    <div id="roleListDialog" class="easyui-dialog"
    data-options="width : 480, closable : true, modal : true, closed : true, shadow : false">
    ...
    <div class="dialog_btnBox" id="group-buttons">
        <a href="javascript:void(0)" class="btn btn-primary"
            onclick="saveObject('groupForm','groupDialog','groupList')">保存</a>
        <a href="javascript:void(0)" class="btn btn-default"
            onclick="javascript:$('#groupDialog').dialog('close')">关闭</a>
    </div>
    <div class="dialog_btnBox" id="group-buttons-update">
        <a href="javascript:void(0)" class="btn btn-primary"
            onclick="saveObject('groupForm2','groupUpdateDialog','groupList')">保存</a>
        <a href="javascript:void(0)" class="btn btn-default"
            onclick="javascript:$('#groupUpdateDialog').dialog('close')">关闭</a>
    </div>
    
    <!-- 对话框 -->
    <div id="distriDialog" class="easyui-dialog"
        style="width: 400px; height: 600px" closed="true"
    ...
    <div id="distri-buttons">
        <a href="javascript:void(0)" class="easyui-linkbutton"
            iconCls="icon-ok"
            onclick="saveRoleResource('${pageContext.request.contextPath}/role/saveRoleResources.htm', 'groupRoleList')">保存</a>
        <a href="javascript:void(0)" class="easyui-linkbutton"
            iconCls="icon-cancel"

...
public class ReportLogAspect {
	...
	public void doAfterThrowing(JoinPoint joinPoint, Throwable e) {
		...
		try {
			...
			/* ========控制台输出========= */
			log.info("=====异常通知开始=====");
			log.info("异常代码:[{}],异常信息:[{}],异常方法:[{}],方法描述:[{}],请求人:[{}],请求IP:[{}],请求参数:[{}]", e.getClass().getName(),
					e.getMessage(), method, info.getOpContent(), user.getMemberName(), ip, params);
			// 日志
		} catch (Exception ex) {
			// 记录本地异常日志
